                    ...
                    <form method="POST" action="<%=request.getContextPath()%>/PartidoServlet?action=guardar">
                        ...
                        <div class="form-group">
                            ...
                            <select name="local" class="form-control">
                                ...
                                <% ArrayList<Seleccion> listarSeleccion = (ArrayList<Seleccion>) request.getAttribute("listarSeleciones");
                                    for (Seleccion seleccion: listarSeleccion) {%>
                                <option value="<%= seleccion.getNombre() %>"><%= seleccion.getNombre() %></option>
                                <% } %>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="arbitro" class="form-control">
                                <% ArrayList<Arbitro> listarArbitros = (ArrayList<Arbitro>) request.getAttribute("listarArbitros");
                                    for (Arbitro arbitro: listarArbitros) {%>
                                <option value="<%= arbitro.getNombre() %>"><%= arbitro.getNombre() %></option>
                                <% } %>
                            </select>
                        </div>
